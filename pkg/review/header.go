...
import (
	...
	comments2 "github.com/step-security/skywalking-eyes/pkg/comments"
	header2 "github.com/step-security/skywalking-eyes/pkg/header"
...
func Markdown(result *header2.Result) string {
	return fmt.Sprintf(`
<!-- %s -->
[license-eye](https://github.com/step-security/skywalking-eyes/tree/main/cmd/license-eye) has checked %d files.
